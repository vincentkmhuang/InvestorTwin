...
try {
  ...
  if ($IndexSrc -notlike '*workflow-engine.js?v=025a1*') { $fail1.Add('index.html is not on workflow-engine.js?v=025a1; a stale tab can keep an older editor/save path') }
