#!/usr/bin/env python3
# EIA Press Releases RSS Bootstrap / First-Enable v1 — seen-only snapshot.
...
ADAPTER_FILE = "collect-eia-press-rss.py"
ADAPTER_MODULE = "collect_eia_press_rss"
...
def main(argv):
    ...
    while i < len(argv):
        ...
        if argv[i] == "--store-root" and i + 1 < len(argv):
            ...
            i += 2
            continue
        sys.stderr.write("EIA_PRESS_BOOTSTRAP_FAIL\nunknown argument: " + argv[i] + "\n")
        return 2
