#!/usr/bin/env python3
# BLS CPI RSS Bootstrap / First-Enable v1 — seen-only snapshot.
...
ADAPTER_FILE = "collect-bls-cpi-rss.py"
ADAPTER_MODULE = "collect_bls_cpi_rss"
...
def main(argv):
    ...
    while i < len(argv):
        ...
        if argv[i] == "--store-root" and i + 1 < len(argv):
            ...
            i += 2
            continue
        sys.stderr.write("BLS_CPI_BOOTSTRAP_FAIL\nunknown argument: " + argv[i] + "\n")
        return 2
